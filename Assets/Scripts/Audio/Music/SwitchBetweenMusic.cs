...
public class SwitchBetweenMusic : MonoBehaviour
{
    // Enum
    ...
    private void Start()
    {
        ...
        /*
            Add Switch-Case, If Statement, or Ternary Operator to determine which BGM to play on Awake, just in case the level begins in DarkMode.
        */
    }
